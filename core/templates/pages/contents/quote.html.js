...
function render(ast, config) {
  ...
  <div style="font-size:26px;font-weight:500;color:#333;line-height:1.6;max-width:700px;font-family:var(--font-heading);">${escapeHTML(quote)}</div>
  ${author ? `<div style="font-size:16px;color:#888;margin-top:24px;">— ${escapeHTML(author)}</div>` : ''}
