...
function render(ast, config) {
  ...
  <div style="font-size:40px;font-weight:800;letter-spacing:4px;margin-bottom:12px;font-family:var(--font-heading);">${escapeHTML(title)}</div>
  ${sub ? `<div style="font-size:18px;opacity:0.7;font-weight:300;">${escapeHTML(sub)}</div>` : ''}
